...
import { transformSupabasePosts, type SupabasePostRaw } from './transform-post'
...
async function fetchHomePosts(page: number = 0, limit: number = 10): Promise<Post[]> {
  ...
  // Transform raw Supabase data to Post format
  return transformSupabasePosts((data || []) as SupabasePostRaw[])
}
